...
import 'package:flutter_news_app_getx/model/ArticalModel.dart';
import 'package:flutter_news_app_getx/model/NewsModel.dart';
...
class NewsController extends GetxController {
  ...
  getNews({channel = '', searchKey = '', reload = false}) async {
    ...
    baseApi += 'apiKey=2c5e2df58f794c6e9caa764aaaf5da55';
    if (channel != '') {
      country.value = '';
      category.value = '';
      baseApi =
